...
\newcommand\reporttitle{Unsupervised Domain Adaptation with Deep Neural-Networks}
...
\\\\\\\\\\\\\
\Large Artem Bitiutskii \\
}

% Add the name of your tutor (for DBL) or any other text.
\newcommand\grouptutor{
\large Supervisors: Massih-Reza Amini and Marianne Clausel
}
...
\counterwithin{equation}{subsection} % For equations
\counterwithin{figure}{section} % For figures
\counterwithin{table}{section} % For tables

% Creates a beautiful header/footer
\pagestyle{fancy}
\lhead{\includegraphics[height = 16pt]{Figures/0. General/output-onlinepngtools.png}}
\rhead{\reporttitle}
